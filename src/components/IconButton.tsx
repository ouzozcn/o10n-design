...
const IconButton: React.FC<IconButtonProps> = ({
  ...
  const typeClasses = {
    ...
    tertiary:
      "w-[58px] h-[58px] p-4 justify-center hover:bg-amber-200 items-center inline-flex",
  };
  ...
  const commonClassNames = `rounded-full flex items-center justify-center ${typeClasses[type]} ${sizeClasses[size]}`;
