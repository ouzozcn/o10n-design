...
const Menu: React.FC<MenuProps> = ({ className }) => {
  ...
  return (
    <>
      <IconButton type="tertiary" size="large" icon={<MenuIcon />} onClick={toggleMenu} />
      {isOpen && (
        <div
        ...
        >
          <div className="flex items-start p-3 gap-2 border-b border-stone-900">
            <div className="flex flex-row gap-2 items-center justify-center">
              <IconButton type="tertiary" size="large" icon={<CloseIcon />} onClick={toggleMenu} />
            </div>
          ...
          <div className="flex flex-col w-full  flex-1">
            <MenuItem to="/" title="Home" className="flex-1 w-full text-2xl border-r-0" />
            <MenuItem
              to="/product"
              title="Products"
            ...
            />
            <MenuItem to="/ideas" title="Ideas" className="flex-1 w-full text-2xl border-r-0" />
            <MenuItem
              to="/articles"
              title="Articles"
              className="flex-1 w-full text-2xl border-r-0"
