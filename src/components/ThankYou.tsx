...
const ThankYou: React.FC<ThankYouProps> = ({
  ...
  <section className={`flex flex-col gap-0 w-full h-auto font-sans ${className}`}>
    <div className="flex w-full h-40 p-8 bg-pink-50 hover:bg-pink-100 border-r-0 border-t border-b border-stone-900 justify-center items-center gap-2 transition-all duration-300">
    ...
    <div className="flex flex-col lg:flex-row gap-0 w-full font-sans">
      {/* Thank You Section */}
      <div className="flex-1 flex flex-col lg:border-r border-stone-900">
        <header className="px-8 py-4 bg-lime-100 border-b border-stone-900 flex items-center text-center lg:text-start">
          <h2 className="text-lg text-center lg:text-start font-sans">🎉 Thanks for Reading!</h2>
        </header>
        <div className="px-6 py-4 text-center lg:text-start text-base font-sans">{message}</div>
      </div>

      {/* Published On Section */}
      {simpleTabs.length > 0 && (
        <div className="flex-1 min-w-72 lg:border-r border-stone-900 flex flex-col">
          <header className="px-6 py-4 bg-yellow-100 border-t lg:border-t-0 border-b border-stone-900 text-center lg:text-start">
            <h2 className="text-lg text-center lg:text-start font-sans">🌍 Also Published On</h2>
          </header>
      ...
      {exploreBlocks && (
        <div className="flex-1 flex flex-col lg:w-1/2">
          <header className="px-6 py-4 bg-orange-100 border-b border-t lg:border-t-0 border-stone-900 text-center lg:text-start">
            <h2 className="text-lg text-center lg:text-start font-sans">🔍 Explore More</h2>
          </header>
