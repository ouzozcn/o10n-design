...
export default function DevFriendlyComponentDesign() {
  return (
    <div className="w-[calc(100%-1rem)] md:w-[calc(100%-4rem)] mx-2 md:mx-8 border-collapse border border-stone-900 min-h-screen bg-theme-primary">
      ...
      <div className="SummaryContent flex w-full  p-4 md:px-16 md:py-8 text-xl items-center justify-center text-center font-medium text-stone-900">
        As a product designer in Jotform&apos;s Enterprise Division, I led the design and rollout of
        a platform-wide Two-Factor Authentication (2FA) feature—addressing 2,000+ user requests and
        fulfilling enterprise-grade security needs without compromising usability.
      </div>
      ...
      <div className="BlogBody flex flex-col md:flex-row gap-0 font-sans">
        <div className="BlogContentContainer flex flex-col w-full md:w-3/4  gap-4 md:border-r border-stone-900">
          <div className="BlogContent flex flex-col w-full   gap-4 ">
            <SectionTitle className="bg-amber-100" title="The Challenge" />
