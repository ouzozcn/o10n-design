...
export const metadata: Metadata = {
  title: 'Playground | Oğuzhan Özcan | Playground for Design Experiments',
  description:
    'A playground for design experiments and prototypes. Playground allows you to design and test your ideas before implementing them.',
  alternates: {
    canonical: 'https://o10n.design/playground',
  },
  openGraph: {
    title: 'Playground | Oğuzhan Özcan | Playground for Design Experiments',
    description:
    ...
    url: 'https://o10n.design/playground',
    type: 'website',
    images: [
      {
        url: 'https://o10n.design/img/og_images/playground_open_graph.png',
        width: 1200,
        height: 630,
        alt: 'Playground - Playground for Design Experiments by Oğuzhan Özcan',
      },
    ],
  ...
  twitter: {
    ...
    title: 'Playground | Playground for Design Experiments',
    description:
      'A playground for design experiments and prototypes. Playground allows you to design and test your ideas before implementing them.',
    images: ['https://o10n.design/img/og_images/playground_open_graph.png'],
    creator: '@ouzozcn',
    site: '@ouzozcn',
  },
  ...
  keywords: [
    // Project Specific
    'playground',
    'playground for design experiments',
    'playground for prototypes',
