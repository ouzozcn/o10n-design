    ...
    <div className="w-[calc(100%-4rem)] mx-8 border-collapse border border-stone-900 min-h-screen bg-theme-primary">
      ...
      <div className="PageHero flex flex-col p-8 md:p-32 w-full md:h-[400px] border-b border-stone-900 justify-center items-center gap-4">
        ...
        <h2 className="text-xl text-center font-sans text-stone-900 flex items-center justify-center">
          a self-taught product designer with a background in physics, a passion
          for building systems, and a deep curiosity for how things work — and
          why people use them.
        </h2>
        <h2 className="text-xl text-center font-sans text-stone-900 flex items-center justify-center">
          Nice to meet you!
      ...
      <div className="PageContent flex flex-col md:flex-row w-full h-full text-stone-900 border-stone-900">
        ...
        <div className="SectionContent flex flex-col grow-1 w-full h-full p-8 border-b border-stone-900 gap-4">
          <p className="text-lg font-sans">
            I began my journey in science, studying Physics at Middle East
            Technical University. Though I didn&apos;t finish the degree, the
            problem-solving mindset, experimental rigor, and systems thinking I
            learned during that time continue to shape how I approach product
            design.
          </p>
          <p className="text-lg font-sans">
            I taught myself design out of necessity, and stayed because I found
            it was the perfect intersection of logic, creativity, and human
            behavior. Since 2020, I&apos;ve been designing SaaS B2B products — first
            at Enocta, and now at Jotform Enterprise, where I work as a Product
            Designer in the Enterprise Division, designing scalable, secure
      ...
      <div className="PageContent flex flex-col md:flex-row w-full h-full text-stone-900 border-stone-900">
        ...
        <div className="SectionContent flex flex-col grow-1 w-full h-full p-8 border-b border-stone-900 gap-4">
          <p className="text-lg font-sans">
            At Jotform, I design for complex features used by thousands of
            enterprise users — from secure form encryption to account management
            and analytics. I collaborate closely with developers, PMs, and
            stakeholders across the company to ship features that are both
            thoughtful and technically feasible.
          </p>
          <p className="text-lg font-sans">
            But beyond UI, I&apos;m deeply interested in how design systems scale,
            how to automate front-end workflows, and how to integrate AI into
      ...
      <div className="PageContent flex flex-col md:flex-row w-full h-full text-stone-900 border-stone-900">
        ...
        <div className="SectionContent flex flex-col grow-1 w-full h-full p-8 border-b border-stone-900 gap-4">
          <p className="text-lg font-sans">
            I love working on side projects — whether it&apos;s building tools for
            accessibility (like Kroma), designing AI-powered lead scoring
            dashboards, or creating frameworks for product research.
          </p>
          <p className="text-lg font-sans">
            I also maintain open-source lab reports for physics students,
            volunteer in accessibility causes (like teaching Braille), and
            occasionally dream of reviving a science newsletter I once started:
            ObserveraScientia.
          </p>
        </div>
      </div>
      ...
      <div className="PageContent flex flex-col md:flex-row w-full h-full md:h-60 text-stone-900 border-stone-900">
        <div className="SectionTitle flex flex-col p-8 grow-1 w-full h-auto items-center justify-center bg-amber-100 gap-4 border-stone-900">
          ...
          <p className="text-lg font-sans">
            ...
            . Whether it&apos;s a collaboration, a freelance idea, or a shared
            curiosity — I&apos;m always open to new conversations.
          </p>
        </div>
      </div>
