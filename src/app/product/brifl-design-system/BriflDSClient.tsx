...
export default function BriflDSClient() {
    ...
    <div className="w-[calc(100%-1rem)] md:w-[calc(100%-4rem)] mx-2 md:mx-8 border-collapse border border-stone-900 min-h-screen bg-theme-primary">
      ...
      <div className="Header sticky top-0 flex p-4 w-full h-auto md:h-[88px] border-b border-stone-900 items-center justify-start gap-4 bg-amber-50 z-10">
        ...
        <div className="HeaderTitle w-full flex flex-col md:flex-row place-content-between gap-4 items-start md:items-center">
          <h1 className="text-xl md:text-2xl font-sans text-stone-900">brifl Design System</h1>
        </div>
      </div>
      ...
      <div className="BodyContainer flex flex-col gap-0 font-sans">
        <div className="mx-16 my-8 text-xl text-center font-medium text-stone-900">
          Before designing the Brifl Form Application, I created the Brifl Design System — a
          modular, React-friendly component library based on atomic design principles. It contains
          over 30 components and 200+ states and variants. This system provided the foundation for
          consistent, accessible, and high-fidelity UI design across the Brifl product.
        </div>
        ...
        <div className="SectionContent font-normal mx-16 my-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <p>
            Before designing the Brifl Form Application, I decided to design a complete system that
            would allow me to create a consistent user interface. So, I designed a design system
            after studying <b>atomic design principles</b> and React-friendly component design,
            named the Brifl Design System. I also used this system for designing the high-fidelity
            user interfaces of the Brifl product.
          </p>
          <br />
          <p>
            The Brifl Design System consists of <b>30 different UI components</b> and more than{' '}
            <b>200 states and variants.</b> It defines the foundational elements such as:
          </p>
          <br />
        ...
        <div className="flex flex-col md:flex-row gap-0">
          <div className="SectionContent font-normal mx-16 my-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
            <p>
              Before starting to design the Brifl Design System, I studied Atomic Design Principles
              by Brad Frost and examined well-defined systems such as:
            </p>
            <ul className="list-disc pl-8 space-y-1 text-left">
              <li>IBM Carbon</li>
            ...
            <p>
              These references helped me define a structure that is both scalable and
              React-compatible.
            </p>
          </div>
        ...
        <div className="SectionContent font-normal mx-16 my-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <p>
            This project allowed me to understand the requirements for designing a modern,
            user-friendly, customizable, interactive, and responsive design system.
          </p>
          <br />
          <ul className="list-disc pl-8 space-y-1 text-left">
            <li>
              When I first began designing this system, I was unfamiliar with Figma&apos;s advanced
              auto-layout features, which made some components less structured than they could have
              been.
            </li>
            <li>
              The system lacks the modern component property structure (booleans, strings, nested
              instances) introduced later in Figma.
            </li>
            <li>
              After this project, I began learning about tokenization (for color, text, spacing,
              etc.) to future-proof design systems.
            </li>
          </ul>
        </div>
        ...
        <ThankYou
          ...
          simpleTabs={[
            {
              icon: (
                <Image src="/img/behance.svg" alt="Behance" width={24} height={24} sizes="24px" />
              ),
              state: 'idle',
            ...
            {
              icon: (
                <Image src="/img/dribbble.svg" alt="Dribbble" width={24} height={24} sizes="24px" />
              ),
              state: 'idle',
