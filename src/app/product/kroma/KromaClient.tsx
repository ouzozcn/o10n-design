...
export default function KromaClient() {
    ...
    <div className="w-[calc(100%-1rem)] md:w-[calc(100%-4rem)] mx-2 md:mx-8 border-collapse border border-stone-900 min-h-screen bg-theme-primary">
      ...
      <div className="PageContent flex flex-col w-full h-full gap-4 p-8 border-b border-stone-900">
        <div className="PageMeta flex flex-col w-full h-full gap-2">
          ...
          <div className="MetaInfoRow flex flex-col md:flex-row w-full px-24 py-4 gap-4 lg:gap-24 justify-center items-center md:items-start">
            ...
            <MetaInfo title="Team" firstMeta="1 Product Designer" secondMeta="1 Front-end Dev" />
            <MetaInfo title="Timeline" firstMeta="April - July 2023" />
            <MetaInfo title="Toolstack" firstMeta="Figma" secondMeta="Vite + React" />
          </div>
        </div>
      </div>
      ...
      <div className="BodyContainer flex flex-col gap-0 font-sans">
        <div className="m-8 text-xl text-center font-medium text-stone-900">
          Kroma is a free and intuitive color blindness accessibility checker designed for product
          and UI/UX designers. It allows users to upload their UI screens and instantly see how they
          appear to individuals with various types of color vision deficiencies. By removing
          paywalls and upload limits, Kroma aims to promote accessible design practices within the
          design community, ensuring that visual communication is inclusive for everyone.
        </div>
        ...
        <div className="SectionContent font-normal px-4 py-4 md:px-16 md:py-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <p>
            As a product designer, I often struggled to validate how my UI designs appeared to users
            with color blindness. While existing tools like Stark and AXE Tools offered simulation
            features, they were usually locked behind paywalls or had limitations like 10-screen
            caps on free plans. I needed something faster, more accessible, and limitless — not just
            for myself, but for the broader design community.
          </p>
        </div>
        ...
        <div className="SectionContent font-normal px-4 py-4 md:px-16 md:py-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <p>
            So I teamed up with a developer friend and built Kroma, a free and simple color
            blindness accessibility checker. The idea was to provide an easy way for designers to
            upload their UI screens and see how they look for people with different types of color
            vision deficiency — without any paywalls or upload limits.
          </p>
        </div>
        ...
        <div className="flex flex-col w-full lg:flex-row gap-0">
          <div className="SectionContent w-full font-normal px-4 py-4 md:px-16 md:py-8 items-center justify-center text-start text-stone-900 font-sans text-lg gap-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Protanomaly and deuteranomaly are among the most common forms, followed by
                tritanomaly and total color blindness.
              </li>
              <li>
                Current design trends rely heavily on color for visual communication, often ignoring
                accessibility.
              </li>
            </ul>
          </div>
          <div className="PageBreakerContainer w-full flex flex-col lg:border-l border-stone-900 gap-0">
            <div className="SectionBlock w-full p-6 bg-lime-50 flex flex-col justify-start gap-2 border-b border-t lg:border-t-0 border-stone-900">
              ...
              <div className="self-stretch text-stone-900 text-md font-normal font-sans">
                <p className="mb-4">
                  Product designers often work on multi-platform experiences where visual
                  consistency and clarity are crucial. Kroma helps them ensure that UI elements
                  (like buttons, alerts, and graphs) remain distinguishable and functional for
                  color-blind users.
                </p>
              </div>
            </div>
            <div className="SectionBlock w-full p-6 bg-pink-50 flex flex-col justify-start gap-2 border-b border-stone-900">
              ...
              <div className="self-stretch text-stone-900 text-md font-normal font-sans">
                <p className="mb-4">
                  These designers are responsible for creating visually intuitive and user-friendly
                  interfaces. Kroma allows them to spot potential accessibility issues early in the
                  design process, preventing poor user experiences for people with vision
                  impairments.
                </p>
              </div>
            </div>
            <div className="SectionBlock w-full p-6 bg-amber-50 flex flex-col justify-start gap-2 border-b border-stone-900">
              ...
              <div className="self-stretch text-stone-900 text-md font-normal font-sans">
                <p className="mb-4">
                  Instructors teaching accessibility, human-centered design, or visual communication
                  can use Kroma as a classroom tool to demonstrate the real-world impact of color
                  choices on usability.
                </p>
              </div>
            </div>
            <div className="SectionBlock w-full p-6 bg-teal-50 flex flex-col justify-start gap-2">
              ...
              <div className="self-stretch text-stone-900 text-md font-normal font-sans">
                <p className="mb-4">
                  These professionals are tasked with auditing and ensuring products meet
                  accessibility standards (like WCAG). Kroma provides a fast and free way to
                  visually verify that color contrast and UI clarity are sufficient for users with
        ...
        <div className="SectionContent flex flex-col md:flex-row font-normal px-4 py-4 md:px-16 md:py-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <div className="flex flex-col w-full gap-2">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Automatically generate and download simulations for: Protanomaly, Deuteranomaly,
                Protanopia, Tritanomaly, Deuteranopia, Tritanopia, Monochromacy, and Achromatopsia.
              </li>
            </ul>
          </div>
          <div className="ColorCards flex flex-col items-center justify-center  w-full mx-4 ">
            ...
            <p className="text-md mt-[-24px] text-stone-500">
              <i>Supported Color Blindness Types</i>
            </p>
          </div>
        </div>
        ...
        <div className="SectionContent font-normal px-4 py-4 md:px-16 md:py-8 items-center justify-center text-start text-stone-900 text-lg gap-4">
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Current design aesthetics often ignore color accessibility; designing with fewer
              colors or offering monochrome alternatives can be game-changing.
            </li>
            <li>
              Working on this project helped me improve my understanding of front-end development
              handoff, product scoping, and collaborative iteration.
            </li>
          </ul>
        </div>
          ...
          exploreBlocks={[
            ...
            <Link key="brifl" href="/ideas/brifl" className="flex-1 h-full">
              <div className="SectionBlock h-full p-6  flex flex-col justify-start items-start gap-2 cursor-pointer hover:bg-pink-200 transition">
                ...
                <div className="self-stretch text-stone-900 text-md font-normal font-sans">
                  A collaborative form-building platform designed to bridge the gap between creators
                  and clients.
                </div>
              </div>
            </Link>,
