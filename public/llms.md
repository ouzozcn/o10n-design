...
-   **Title**: Oguzhan Ozcan | Product Designer & Design Engineer
-   **Language**: en-US
...
-   **Name**: Oğuzhan Özcan
-   **Alternate Names**: Oguzhan Ozcan, Oğuz Özcan
...
-   `/writings` - Articles and technical blog posts
...
-   `/writings/dev-friendly-component-design` - Component design best
    practices for developer collaboration
-   `/writings/using-tokens-in-figma` - Design tokens implementation
    guide and workflow
...
Design-Development Collaboration, Technical Writing, Portfolio Design,
...
-   **Technical Writing**: Published technical articles on
...
[
  { "@context": "https://schema.org", "@type": "Person", "@id": "https://o10n.design/#person",
    "name": "Oğuzhan Özcan", "alternateName": ["Oguzhan Ozcan", "Oğuz Özcan"],
